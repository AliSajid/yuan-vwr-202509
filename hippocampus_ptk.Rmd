...
params:
  chip_type: PTK
  signal_file: "kinome_data/PTK/Hippocampus/_ExportstosDB_Median_SigmBg_250907163617.txt" # Change the file name to the one you have
  saturation_file: "kinome_data/PTK/Hippocampus/_ExportstosDB_Signal_Saturation_250907163620.txt" # Change the file name to the one you have
...
qc_data <- krsa_qc_steps(raw_data) |>
    mutate(
        Group = case_when(
            SampleName == "Sedentary + Veh_Hippocampus" ~ "Sed_Veh",
            SampleName == "Sedentary + EB_Hippocampus" ~ "Sed_EB",
            SampleName == "VWR + Veh_Hippocampus" ~ "VWR_Veh",
            SampleName == "VWR + EB_Hippocampus" ~ "VWR_EB"
        ),
